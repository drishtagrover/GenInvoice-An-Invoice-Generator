                ...
                <table className="table mb-0 ">
                    ...
                    {data.items.map((item, index) => (
                        <tr key={index} className="items-row">
                            ...
                            <td className="p-3 text-center">{data.currencySymbol}{Number(item.amount ?? 0).toFixed(2)}</td>
                            <td className="p-3 text-end">{data.currencySymbol}{(Number(item.qty) * Number(item.amount ?? 0)).toFixed(2)}</td>
                        </tr>
                    ))}
                    </tbody>
                </table>
