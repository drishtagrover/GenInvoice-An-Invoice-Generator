                    ...
                    <div className="row py-lg-5">
                        <div className="col-lg-9 col-md-10 mx-auto">
                            <h1 className="display-3 fw-bold mb-4">
                                Precision Invoicing. Built for Business.
                            </h1>
                            ...
                            <p>
                                ...
                                <button className="btn btn-lg btn-warning fw-bold rounded-pill my-2 mx-1 px-5 py-3">
                                    Generate Your First Invoice with GenInvoice.
                                </button>
                ...
                <div className="container">
                    ...
                    <div className="row align-items-center gy-4">
                        ...
                        <div className="col-md-6">
                            ...
                            <p className="text-muted lead fs-6 mx-2">
                                Easily input invoice details with a user-friendly interface designed for quick data entry. Fields like client name, item description, quantity, and price are clearly organized for smooth and error-free billing.
                            </p>
                    ...
                    <div className="row align-items-center gy-4 mt-5 flex-row-reverse"> {/* flex-row-reverse alternates image/text */}
                        ...
                        <div className="col-md-6">
                            ...
                            <p className="text-muted lead fs-6 mx-2">
                                Experience a beautiful, intuitive dashboard with a clean layout and vibrant visuals. Easily track invoices, payments, and client activity all in one organized view.
                            </p>
                            <ul className="list-unstyled text-muted">
                    ...
                    <div className="row align-items-center gy-4 mt-5">
                        ...
                        <div className="col-md-6">
                            ...
                            <p className="text-muted lead fs-6 mx-2">
                                Instantly preview your invoice before sending, with a clear layout that mirrors the final document. Action buttons like Edit, Download, and Send offer seamless control at your fingertips.
                            </p>
                            <ul className="list-unstyled text-muted">
                    ...
                    <div className="row align-items-center gy-4 mt-5 flex-row-reverse"> {/* flex-row-reverse alternates image/text */}
                        ...
                        <div className="col-md-6">
                            ...
                            <p className="text-muted lead fs-6 mx-2">
                                Send invoices instantly with just one click, directly from the dashboard. Ensure faster payments and streamlined communication with clients in real time.
                            </p>
                            <ul className="list-unstyled text-muted">
            ...
            <footer className="py-5 bg-dark text-white-50">
                <div className="container text-center">
                    ...
                    <p className="mt-2">
                        ...
                        <a href="#" className="text-white-50 me-2"><FaTwitter size={24} /></a>
                        <a href="#" className="text-white-50 me-2"><FaLinkedin size={24} /></a>
                        <a href="#" className="text-white-50"><FaFacebook size={24} /></a>
                    </p>
                </div>
            </footer>
        </>
